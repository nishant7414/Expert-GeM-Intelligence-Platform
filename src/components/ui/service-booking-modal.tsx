...
export function ServiceBookingModal({ isOpen, onClose, selectedService }: ServiceBookingModalProps) {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      toast.success('Thank you. Our team will contact you shortly regarding your selected service.')
      onClose()
      reset()
    } catch (error: any) {
        ...
        >
          ...
          <div className="p-6 border-b border-slate-100 flex justify-between items-center sticky top-0 bg-white z-10">
            <div>
              ...
              <p className="text-slate-500 mt-1">Please provide your details below.</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="overflow-y-auto p-6">
            <form id="service-booking-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="industry" className="block text-sm font-semibold mb-2 text-slate-700">
                    Industry *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="city" className="block text-sm font-semibold mb-2 text-slate-700">
                    City *
                  </label>
                  <input
                    type="text"
              ...
              <div>
                <label htmlFor="businessType" className="block text-sm font-semibold mb-2 text-slate-700">
                  Business Type *
                </label>
                <select
                  id="businessType"
                  {...register("businessType")}
                  className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors bg-white"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Any specific details or requirements you have..."
                ></textarea>
              </div>
